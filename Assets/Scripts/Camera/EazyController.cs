...
namespace EazyCamera
{
    ...
    public class EazyController : MonoBehaviour
    {
        ...
        public Canvas weaponInventoryPanel; // Assign in Inspector
        public Canvas otherCanvas; // Assign in Inspector
        ...
        private void Start()
        {
            Debug.Assert(_controlledCamera != null, "Attempting to use a controller on a GameObject without an EazyCam component");
        ...
        {
            if (weaponInventoryPanel != null && otherCanvas != null)
            {
                bool isActive = weaponInventoryPanel.gameObject.activeSelf;
                weaponInventoryPanel.gameObject.SetActive(!isActive);
                otherCanvas.gameObject.SetActive(isActive);
            }
        }
    }
}
